...
xorpd xmm15, xmm15 ; xmm15 will hold the sum
...
; Get the current element and save it to xmm11
...
leaveloop:
cvtsi2sd xmm14, r14 ; Store the number of elements into xmm14
divsd xmm14, xmm15  ; Calculate the Harmonic Mean
movsd xmm0, xmm14   ; Return the Harmoic Mean
